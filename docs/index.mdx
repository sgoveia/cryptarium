...
<Info>
  Status: **v0.2: public HTTPS remote scan + inventory.** Core detectors, correlation, scoring, CBOM/SARIF, and the GitHub Action ship on tagged releases. Interfaces may still evolve before 1.0.
</Info>
