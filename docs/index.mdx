...
<Info>
  Status: **v0.2.1: embedded rule packs + public HTTPS remote scan.** Core detectors, correlation, scoring, CBOM/SARIF, and the GitHub Action ship on tagged releases. Interfaces may still evolve before 1.0.
</Info>
